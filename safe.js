    ...
    var interval = 5;
 	var interval_ = setInterval(function(){
 		...
 		if(interval === 0){
 			...
 			$('.safelink_page').html('<div style="text-align:center;margin:10px;" class="button_safe">Klik 2x gan hehe.</div>');
 			$('.safelink_home').html('<div style="text-align:center;margin:10px;"><div onclick="verfy()" class="button_safe">Verifikasi jika anda wibu!!</div></div>');
 		}
 	}, 1000);
